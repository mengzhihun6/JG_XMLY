...
class JGRecommendNewsCell: JGBaseCollectionCell {
    
    private var topBuzz:[JGTopBuzzModel]?
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(cellType: JGNewsCell.self)
...
extension JGRecommendNewsCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: JGNewsCell.self)
...
class JGNewsCell: JGBaseCollectionCell {
