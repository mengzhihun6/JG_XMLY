...
let timeoutClosure = {(endpoint: Endpoint, closure: MoyaProvider<RecommendAPi>.RequestResultClosure) -> Void in
...
let RecommendProvider = MoyaProvider<RecommendAPi>(requestClosure: timeoutClosure)
let ApiLoadingProvider = MoyaProvider<RecommendAPi>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
