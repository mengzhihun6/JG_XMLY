...
// 最外层的model
struct JGHomeRecommendModel: HandyJSON {
    var msg:String?
    var ret:Int = 0
    var code:String?
    var list:[JGRecommendModel]?
}

// 里层的model
struct JGRecommendModel: HandyJSON {
    var bottomHasMore: Bool = false
    var hasMore: Bool = false
    var list: [JGRecommendListModel]?
    var loopCount: Int = 0
    var moduleId: Int = 0
    ...
    var target: JGTarget?
    var recWords: [JGRecWords]?
    
    var categoryId: Int = 0
    var direction: String?
    var keywords: [JGKeywords]?
    
}
struct JGRecommendListModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
...
struct JGTarget: HandyJSON{
    var groupId: Int = 0
    var categoryId: Int = 0
}
struct JGRecWords: HandyJSON{
    var contentType: String?
    var properties:JGProperties?
    var title: String?
}
struct JGProperties: HandyJSON {
    var isPaid: Bool = false
    var type: String?
    var uri: String?
    var albumId: Int = 0
}
struct JGKeywords: HandyJSON {
    var categoryId: Int = 0
...
struct JGFocusModel: HandyJSON {
    var data: [JGBannerData]?
    var responseId: Int = 0
    var ret : Int = 0
}

struct JGBannerData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct JGSquareModel: HandyJSON {
...
struct JGTopBuzzModel: HandyJSON {
    var albumId: Int = 0
...
struct JGGuessYouLikeModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var infoType: String?
...
struct JGPaidCategoryModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var commentScore: CGFloat = 0.0
...
struct JGPlaylistModel: HandyJSON {
...
struct JGOneKeyListenModel: HandyJSON {
    var channelId: Int = 0
    var channelName: String?
    var cover: String?
    var coverRound: String?
    var onLineNum: Int = 0
    var recInfo: JGRecInfo?
}

struct JGRecInfo: HandyJSON {
    var recSrc: String?
    var recTrack: String?
}

struct JGLiveModel: HandyJSON {
...
struct JGRecommnedAdvertModel: HandyJSON {
    var shareData: JGAdvertShareData?
    var isShareFlag: Bool = false
...
struct JGAdvertShareData: HandyJSON {
    var linkUrl: String?
